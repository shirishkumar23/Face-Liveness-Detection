...
def random_index_shuffle(index, seed, max_index, name=None):
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        _ctx, "RandomIndexShuffle", name, index, seed, max_index)
      return _result
  ...
  if _execute.must_record_gradient():
    _attrs = ("dtype", _op._get_attr_type("dtype"), "Tseed",
...
def random_index_shuffle_eager_fallback(index, seed, max_index, name, ctx):
  ...
  _attrs = ("dtype", _attr_dtype, "Tseed", _attr_Tseed)
