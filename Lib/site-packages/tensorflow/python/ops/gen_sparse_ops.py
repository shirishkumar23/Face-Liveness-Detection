...
def sparse_cross_hashed(indices, values, shapes, dense_inputs, num_buckets, strong_hash, salt, name=None):
  r"""Generates sparse cross from a list of sparse and dense tensors.
...
def sparse_cross_v2(indices, values, shapes, dense_inputs, sep, name=None):
  r"""Generates sparse cross from a list of sparse and dense tensors.
...
def sparse_softmax_eager_fallback(sp_indices, sp_values, sp_shape, name, ctx):
  _attr_T, (sp_values,) = _execute.args_to_matching_eager([sp_values], ctx, [_dtypes.float32, _dtypes.float64, ])
  sp_indices = _ops.convert_to_tensor(sp_indices, _dtypes.int64)
  sp_shape = _ops.convert_to_tensor(sp_shape, _dtypes.int64)
